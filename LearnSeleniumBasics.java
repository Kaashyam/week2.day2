...
public class LearnSeleniumBasics {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("//*[@id=\"createLeadForm_firstName\"]")).sendKeys("Shyam sundar");
		driver.findElement(By.xpath("//input[@id = 'createLeadForm_lastName']")).sendKeys("Venugopal");
